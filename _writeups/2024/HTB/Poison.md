...
⚠️ Note: We're using a reverse shell payload based on the mkfifo method, URL-encoded for the HTTP GET request. This one-liner was adapted from [revshells.com](https://revshells.com).
